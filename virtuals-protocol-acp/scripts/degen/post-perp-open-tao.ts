/**
 * TAO short open — perp_trade (Degen Claw / Hyperliquid).
 *
 * `size` = USDC notional.
 *
 * Usage:
 *   tsx scripts/degen/post-perp-open-tao.ts [usdc_notional] [leverage]
 *   Defaults: notional 15, leverage 5, side short.
 */
